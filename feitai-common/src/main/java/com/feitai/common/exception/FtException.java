...
public class FtException extends NestedCheckedException implements Messageable {
	...
	public FtException(String errorCode) {
		super(errorCode);
	...
	public FtException(String errorCode, Object[] args) {
		super(errorCode);
		if (StringUtil.isEmpty(errorCode))
			this.messageSupport.setMessageKey(DEFAULT_MESSAGE_KEY);
		else
	...
	public FtException(String errorCode, Throwable paramThrowable) {
	...
	public FtException(String errorCode, Throwable paramThrowable, Object[] args) {
		super(errorCode, paramThrowable);
		if (StringUtil.isEmpty(errorCode))
			this.messageSupport.setMessageKey(DEFAULT_MESSAGE_KEY);
		else
	...
	public FtException(Throwable paramThrowable) {
